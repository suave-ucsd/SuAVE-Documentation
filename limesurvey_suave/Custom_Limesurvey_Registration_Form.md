...
Often, SuAVE galleries allow users to update individual entries by selecting their profile in SuAVE and clicking "CLICK TO UPDATE YOUR ENTRY" in the right frame (e.g. [https://suave-net.sdsc.edu/main/file=suavedemos_USMEX_Fellows.csv&view=grid](https://suave-net.sdsc.edu/main/file=suavedemos_USMEX_Fellows.csv&view=grid)). In the mappings spreadsheet (which defines how LimeSurvey variables translate into SuAVE fields), this field is typically described as:
